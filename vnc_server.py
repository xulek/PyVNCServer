...
class VNCServer:
        ...
        try:
            ...
            # Existing code in handle_client_messages
                ...
                if VNCServer.SUPPORTED_ENCODINGS[message_type] == "Cursor":
                    ...
                    hotspot_x, hotspot_y, width, height = struct.unpack(">HHHH", VNCServer.recv_exact(client_socket, 8))
                    ...
                    width, height = struct.unpack(">HH", VNCServer.recv_exact(client_socket, 4))
    ...
    def handle_pointer_event(button_mask, x_position, y_position):
        ...
        if (x_position < safe_margin or x_position > screen_width - safe_margin or
            ...
            print("Pozycja kursora zbyt blisko rogu ekranu, ruch anulowany.")
            return
